...
static const struct iio_chan_spec bma023_channels[] = {
	BMA023_ACC_CHANNEL(X, 14),
	BMA023_ACC_CHANNEL(Y, 14),
	BMA023_ACC_CHANNEL(Z, 14),
...
static const struct bma180_part_info bma180_part_info[] = {
	[BMA023] = {
		...
		bma023_scale_table, ARRAY_SIZE(bma023_scale_table),
		bma023_bw_table, ARRAY_SIZE(bma023_bw_table),
		BMA023_CTRL_REG0, BMA023_INT_RESET_MASK,
		BMA023_CTRL_REG0, BMA023_SLEEP,
		BMA023_CTRL_REG2, BMA023_BW_MASK,
		BMA023_CTRL_REG2, BMA023_RANGE_MASK,
		0, 0, 0, /* No low power mode */
		BMA023_CTRL_REG3, BMA023_NEW_DATA_INT,
		BMA180_RESET, BMA023_RESET_VAL,
		bma023_chip_config,
		bma023_chip_disable,
	},
	[BMA180] = {
...
MODULE_DESCRIPTION("Bosch BMA023/BMA180/BMA250 triaxial acceleration sensor");
MODULE_LICENSE("GPL");
